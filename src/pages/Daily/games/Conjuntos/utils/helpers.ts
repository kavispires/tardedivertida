...
import type { DailyConjuntosEntry, GameState } from './types';
...
export const getInitialState = (data: DailyConjuntosEntry): GameState => {
 ...
 * @param data - The DailyConjuntosEntry data.
