...
import type { DailyConjuntosEntry, GameState, Guess, SessionState, TThing } from './types';

export function useConjuntosEngine(data: DailyConjuntosEntry, initialState: GameState) {
