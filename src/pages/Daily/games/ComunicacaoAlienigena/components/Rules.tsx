        ...
        <Translate
          pt={
            <>
              ...
              <li>
                Por exemplo, o que uma bola, uma melancia e uma pizza tem em comum? Todos são redondos! Será
                que o alienígena quer dizer que aquele símbolo significa redondo?
              </li>
              <li>
                Você deve entregar as 4 coisas na ordem correta de uma vez. O alienígena apenas te diz se
                todas estão corretas ou não.
              </li>
              <li>
          ...
          en={
            <>
              ...
              <li>
                For example, what does a ball, a watermelon, and a pizza have in common? They're all round!
                Does the alien mean that symbol represents round?
              </li>
              <li>
      ...
      additionalRules={
        <Translate
          pt={
            <>
              <strong>Dicas:</strong>
              <li>Para entender melhor os símbolos, clique no botão "Entenda como o alienígena pensa"</li>
            </>
          }
          en={
            <>
              <strong>Tips:</strong>
              <li>To better understand the symbols, click the "Understand how the alien thinks" button</li>
            </>
          }
        />
      }
