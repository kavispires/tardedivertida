...
import type { DailyInvestigacaoEntry, GameState, SessionState } from './types';

export function useInvestigacaoEngine(data: DailyInvestigacaoEntry, initialState: GameState) {
