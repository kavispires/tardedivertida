...
import type { DailyInvestigacaoEntry, GameState } from './types';
 ...
 * @param data - The DailyInvestigacaoEntry object containing the necessary data for the game.
 * @returns The initial GameState object.
 */
export const getInitialState = (data: DailyInvestigacaoEntry): GameState => {
 ...
 * @param data - The DailyInvestigacaoEntry data.
