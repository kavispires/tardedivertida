    ...
    <RulesWrapper
      ...
      basicRules={
        <Translate
          en={
            <>
              <li>You are a detective investigating a crime and need to find out who the culprit is.</li>
              <li>
          ...
          pt={
            <>
              <li>Você é um detetive investigando um crime e precisa descobrir quem é o culpado.</li>
              <li>
