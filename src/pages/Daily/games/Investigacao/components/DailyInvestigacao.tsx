...
type DailyInvestigacaoProps = {
  data: DailyInvestigacaoEntry;
  currentUser: Me;
};

export function DailyInvestigacao({ data }: DailyInvestigacaoProps) {
  ...
  return (
    <Layout>
      ...
      <DailyContent>
        ...
        <Region>
          <Image.PreviewGroup>
            <div className="investigacao-suspects-grid">
                ...
                return (
                  ...
                  >
                    <ImageCard
                      ...
                      cardWidth={width}
                      className={clsx('investigacao-suspect-card', {
                        'investigacao-released-suspect': isReleased,
                        'investigacao-culprit-suspect': isComplete && data.culpritId === suspect.id,
                      })}
                      preview={false}
                    />
                    <Button
