...
import type { DailyVitralEntry, GameState } from './types';
 ...
 * @param data - The DailyVitralEntry object containing the necessary data for the game.
 * @returns The initial GameState object.
 */
export const getInitialState = (data: DailyVitralEntry): GameState => {
 ...
 * @param data - The DailyVitralEntry data.
