...
export const DEMO: DailyEspionagemEntry[] = [
  {
    ...
    statements: [
      {
        key: 'testimony.t-37-pt',
        text: 'O(a) suspeito(a) não é romântico(a)',
        excludes: [
          'us-150',
          'us-132',
          'us-27',
      ...
      },
      {
        ...
        excludes: ['us-18', 'us-57', 'us-10'],
        type: 'feature',
      },
      {
        key: 'not.feature.blueClothes',
        text: 'O(a) suspeito(a) não está vestindo roupas azuis',
        excludes: ['us-27', 'us-59', 'us-93', 'us-100', 'us-57'],
        type: 'feature',
      },
      {
        key: 'testimony.t-84-pt',
        text: 'O(a) suspeito(a) não gosta de jogos de tabuleiro',
        excludes: ['us-93'],
        type: 'testimony',
      },
      {
        ...
        excludes: ['us-10', 'us-14', 'us-27'],
        type: 'grid',
      },
      {
        key: 'not.feature.thin',
        text: 'O(a) suspeito(a) não é magrelo(a)',
        excludes: ['us-100', 'us-14', 'us-57'],
        type: 'feature',
      },
    ],
    additionalStatements: [
      {
        key: 'not.feature.bald',
        text: 'O(a) suspeito(a) não é careca',
        excludes: ['us-132', 'us-27', 'us-59', 'us-97', 'us-100'],
        type: 'feature',
      },
      {
        key: 'not.grid.row2',
        text: 'O(a) suspeito(a) não está na segunda linha',
        excludes: ['us-14', 'us-150', 'us-132', 'us-100'],
        type: 'grid',
      },
    ],
    suspects: [
      {
        ...
        gender: 'male',
        features: ['male', 'senior', 'caucasian', 'tall', 'average', 'hat'],
      },
      {
        id: 'us-97',
        name: {
        ...
        gender: 'male',
        features: ['male', 'adult', 'caucasian', 'medium', 'average', 'bald'],
      },
      {
        id: 'us-93',
        name: {
        ...
        gender: 'male',
        features: ['male', 'adult', 'caucasian', 'tall', 'large', 'blueClothes'],
      },
      {
        id: 'us-59',
        name: {
        ...
        gender: 'male',
        features: ['male', 'senior', 'caucasian', 'medium', 'large', 'bald', 'blueClothes'],
      },
      {
        id: 'us-14',
        name: {
        ...
        gender: 'male',
        features: ['male', 'adult', 'caucasian', 'tall', 'thin'],
      },
      {
        id: 'us-150',
        name: {
        ...
        gender: 'female',
        features: ['female', 'adult', 'caucasian', 'medium', 'muscular'],
      },
      {
        id: 'us-132',
        name: {
        ...
        gender: 'male',
        features: ['male', 'adult', 'caucasian', 'tall', 'muscular', 'bald'],
      },
      {
        id: 'us-100',
        name: {
        ...
        gender: 'male',
        features: ['male', 'adult', 'caucasian', 'short', 'thin', 'bald', 'blueClothes'],
      },
      {
        id: 'us-27',
        name: {
        ...
        gender: 'male',
        features: ['male', 'senior', 'caucasian', 'short', 'average', 'bald', 'blueClothes'],
      },
      {
        id: 'us-19',
        name: {
      ...
      },
      {
        ...
        gender: 'female',
        features: ['female', 'senior', 'caucasian', 'short', 'thin', 'hat', 'blueClothes'],
      },
      {
        id: 'us-18',
        name: {
    ...
    reason: {
      en: 'Built a charity that funneled hugs directly into surveillance data.',
      pt: 'Criou uma ONG que transformava abraços em dados de vigilância.',
    },
    setId: 'us-19::cr-142::testimony.t-37-pt',
    level: 3,
  },
  {
    id: '2025-06-30',
