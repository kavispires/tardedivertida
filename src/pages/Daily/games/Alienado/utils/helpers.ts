...
import type { DailyAlienadoEntry, GameState } from './types';
...
export const getInitialState = (data: DailyAlienadoEntry): GameState => {
 ...
 * @param data - The DailyAlienadoEntry data.
