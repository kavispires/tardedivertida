...
import type { DailyEstoquistaEntry, GameState, SessionState } from './types';

export function useEstoquistaEngine(data: DailyEstoquistaEntry, initialState: GameState) {
