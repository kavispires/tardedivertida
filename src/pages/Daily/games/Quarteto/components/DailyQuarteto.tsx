...
import { useQuartetoEngine } from '../utils/useQuartetoEngine';
import { Prompt } from './Prompt';
import { ResultsModalContent } from './ResultsModalContent';
import { Rules } from './Rules';

type DailyQuartetoProps = {
  data: DailyQuartetoEntry;
  currentUser: Me;
};

export function DailyQuarteto({ data }: DailyQuartetoProps) {
  const { hearts, guesses, showResultModal, setShowResultModal, isWin, isComplete, guessLetter, solution } =
    useQuartetoEngine(data);
