type BoxCheckMarkIconProps = React.SVGProps<SVGSVGElement> & {
  /** Main color of the icon. Defaults to green */
  color?: string;
};

export function BoxCheckMarkIcon({ color, ...props }: BoxCheckMarkIconProps) {
  // Default colors
  const mainColor = color || '#69bb69';
  const darkColor = color || '#53b652';
