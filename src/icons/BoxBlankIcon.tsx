type BoxBlankIconProps = React.SVGProps<SVGSVGElement> & {
  /** Main color of the icon. Defaults to gray */
  color?: string;
};

export function BoxBlankIcon({ color, ...props }: BoxBlankIconProps) {
  // Default colors
  const mainColor = color || '#ababab';
  const darkColor = color || '#878787';
