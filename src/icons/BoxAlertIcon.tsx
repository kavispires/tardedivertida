type BoxAlertIconProps = React.SVGProps<SVGSVGElement> & {
  /** Main color of the icon. Defaults to orange */
  color?: string;
};

export function BoxAlertIcon({ color, ...props }: BoxAlertIconProps) {
  // Default colors
  const mainColor = color || '#fb9927';
  const darkColor = color || '#f98824';
  ...
  return (
    ...
    >
      ...
      <path
        fill="#ffeee6"
        d="M275 284.1h-38a15.45 15.45 0 01-15.5-15.5V121.8a15.45 15.45 0 0115.5-15.5h38a15.45 15.45 0 0115.5 15.5v146.8a15.45 15.45 0 01-15.5 15.5z"
      ></path>
      <path d="M275 291.1h-38a22.53 22.53 0 01-22.5-22.5V121.8A22.53 22.53 0 01237 99.3h38a22.53 22.53 0 0122.5 22.5v146.8a22.53 22.53 0 01-22.5 22.5zm-38-177.8a8.37 8.37 0 00-8.5 8.5v146.8a8.37 8.37 0 008.5 8.5h38a8.37 8.37 0 008.5-8.5V121.8a8.37 8.37 0 00-8.5-8.5z"></path>
      <path
        fill="#ffeee6"
        d="M275.5 382.3h-38a15.45 15.45 0 01-15.5-15.5v-38a15.45 15.45 0 0115.5-15.5h38a15.45 15.45 0 0115.5 15.5v38a15.45 15.45 0 01-15.5 15.5z"
      ></path>
      <path d="M275.5 389.3h-38a22.53 22.53 0 01-22.5-22.5v-38a22.53 22.53 0 0122.5-22.5h38a22.53 22.53 0 0122.5 22.5v38a22.53 22.53 0 01-22.5 22.5zm-38-69a8.37 8.37 0 00-8.5 8.5v38a8.37 8.37 0 008.5 8.5h38a8.37 8.37 0 008.5-8.5v-38a8.37 8.37 0 00-8.5-8.5z"></path>
    </svg>
  );
}
