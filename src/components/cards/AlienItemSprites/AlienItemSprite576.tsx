...
// Images
import items from 'assets/images/alien-items-576.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite576({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite576;
