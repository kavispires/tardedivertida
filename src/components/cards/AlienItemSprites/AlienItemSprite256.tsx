...
// Images
import items from 'assets/images/alien-items-256.svg';

function AliemItemSprite256({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite256;
