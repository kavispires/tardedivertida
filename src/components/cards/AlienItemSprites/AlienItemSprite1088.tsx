...
// Images
import items from 'assets/images/alien-items-1088.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite1088({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite1088;
