...
// Images
import items from 'assets/images/alien-items-128.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite128({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite128;
