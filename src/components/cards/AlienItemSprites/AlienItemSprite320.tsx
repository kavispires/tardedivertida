...
// Images
import items from 'assets/images/alien-items-320.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite320({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite320;
