...
// Images
import items from 'assets/images/alien-items-704.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite704({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite704;
