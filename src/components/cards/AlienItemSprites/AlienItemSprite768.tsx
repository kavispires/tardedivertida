...
// Images
import items from 'assets/images/alien-items-768.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite768({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite768;
