...
// Images
import items from 'assets/images/alien-items-448.svg';

function AliemItemSprite448({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite448;
