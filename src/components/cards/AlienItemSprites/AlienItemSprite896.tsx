...
// Images
import items from 'assets/images/alien-items-896.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite896({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite896;
