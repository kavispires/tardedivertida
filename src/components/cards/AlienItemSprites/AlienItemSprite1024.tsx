...
// Images
import items from 'assets/images/alien-items-1024.svg';

function AliemItemSprite1024({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite1024;
