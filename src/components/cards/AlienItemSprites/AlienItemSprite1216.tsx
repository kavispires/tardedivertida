...
// Images
import items from 'assets/images/alien-items-1216.svg';

function AliemItemSprite1216({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite1216;
