...
// Images
import items from 'assets/images/alien-items-384.svg';

function AliemItemSprite384({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite384;
