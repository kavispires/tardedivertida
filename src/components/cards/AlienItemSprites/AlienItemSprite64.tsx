...
// Images
import items from 'assets/images/alien-items-64.svg';
// Types
import type { ItemCardProps } from '../ItemCard';

function AliemItemSprite64({ id, width = 75, className = '', title }: ItemCardProps) {
  return (
...
export default AliemItemSprite64;
