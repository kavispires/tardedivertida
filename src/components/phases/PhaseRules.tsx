...
export function PhaseRules({ players, info }: PhaseRulesProps) {
  ...
  // DEV: Auto-ready
  useMock(() => onBeReady({ action: GAME_API_ACTIONS_V1.MAKE_PLAYER_READY }), [], 2);
    ...
    <Layout.Content className="phase-rules">
      ...
      <Space className="phase-rules__actions" wrap>
        <Button
          ...
          onClick={() => onBeReady({ action: GAME_API_ACTIONS_V1.MAKE_PLAYER_READY })}
          loading={isLoading}
        >
          <Translate
        ...
        <Button
          ...
          disabled={isLoading || user.isReady}
          onClick={() => onBeReadyIDK({ action: GAME_API_ACTIONS_V1.MAKE_PLAYER_READY })}
          loading={isLoading}
        >
        ...
        <Button
          ...
          disabled={isLoading || user.isReady}
          onClick={() => onBeReadyQue({ action: GAME_API_ACTIONS_V1.MAKE_PLAYER_READY })}
          loading={isLoading}
        >
