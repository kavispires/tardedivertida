...
export function StepWaitClover({
  activeCloverPlayer,
  clover,
  leaves,
}: StepWaitCloverProps) {
  const {
    ...
    onRotateClover,
    usedLeavesIds,
  } = useCloverState("view", clover, leaves);
    ...
    <Step fullWidth>
      <Title size="medium">
        <Translate
          pt={
            <>
              Adivinhação do trevo do(a){" "}
              <AvatarName player={activeCloverPlayer} />
            </>
          }
          en={
            <>
        ...
        <Translate
          ...
          en={
            <>
              ...
              <br /> In the meantime, check it out the cards they have
              available.
            </>
          }
        />
