...
export function AllAnswersDrawer({
  ...
  return (
    <>
      ...
      <Flex justify="space-around" align="center" wrap gap={12}>
...
function PlayerEntry({ player, isUser, questionsDict, grid, eliminations = {} }: PlayerEntryProps) {
  ...
  const answers: NumberDictionary = identity.answers;
      ...
      {Object.entries(answers).map(([questionId, answer]) => {
        ...
        return (
          <Flex key={questionId} justify="space-between">
            ...
            {answer === -1 && <IconAvatar size="small" icon={<BoxMinusIcon color="#e8818c" />} />}
            {answer === 1 && <IconAvatar size="small" icon={<BoxPlusIcon color="#83d39c" />} />}
            {answer === 3 && (
              <Flex>
