    ...
    <Step fullWidth announcement={announcement}>
      ...
      <RuleInstruction type="action">
        <Translate
          pt={
            <>
              Clique em cada um dos jogadores e elimine todos os personagens que você acha que não cabem
              aquele jogador deixando apenas um personagem sem o <IconAvatar size="small" icon={<XIcon />} />.
              Quando você fizer isso com todos os jogadores, o botão de enviar ficará disponível.
            </>
          }
          en={
            <>
              Click on each player and eliminate all characters you think don't fit that player, leaving only
              one character without the <IconAvatar size="small" icon={<XIcon />} />. When you do this for all
              players, the submit button will become available.
            </>
          }
        />
      </RuleInstruction>
