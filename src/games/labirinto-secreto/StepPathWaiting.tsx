        ...
        <Translate
          pt={
            <>
              ...
              jogadores = 3 pontos.
              <br />
              Se somente um jogador acertar o caminho, ele ganha <PointsHighlight value={playerCount} />.
              <br />
          ...
          en={
            <>
              ...
              <br />
              If only one player guesses the path, they earn <PointsHighlight value={playerCount} />.
              <br />
