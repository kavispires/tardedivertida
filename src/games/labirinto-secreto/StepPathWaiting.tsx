  ...
  return (
    ...
    >
      ...
      <RuleInstruction type="wait">
        <Translate
          pt="Baseado no <mapa>mapa de adjetivos</mapa>, eles vão clicando nas <arvores>árvores</arvores> para escolher o caminho.<br/>Cada árvore correta vale {points} por jogador que acertar. Por exemplo, 3 jogadores = 3 pontos.<br/>Se somente um jogador acertar o caminho, ele ganha {playerPoints}.<br/>Você, como criador do mapa, ganha o mesmo número de pontos que os jogadores."
          en="Based on the <mapa>adjectives map</mapa>, players will click on the <arvores>trees</arvores> to choose the path.<br/>Each correct tree is worth {points} per player that guesses it. For example, 3 players = 3 points.<br/>If only one player guesses the path, they earn {playerPoints}.<br/>You as the map creator also earns the same number of points as the players."
          values={{
