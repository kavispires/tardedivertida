    ...
    <Step fullWidth announcement={announcement}>
      ...
      <Title>
        {isJudge ? (
          <Translate
            pt={
              <>
                Como Juiz, coloque uma coisa no diagrama para ajudar os outros
                jogadores
              </>
            }
            en={
              <>
                As the Judge, place an item on the diagram to help the other
                players
              </>
            }
          />
          ...
          <Translate
            pt={
              <>
                Selecione um item e uma área do diagrama que você acha que ele
                pode se encaixar
              </>
            }
            en={
              <>
                Select an item and an area of the diagram where you think it
                could fit
              </>
            }
          />
      ...
      <MouseFollowingContent
        active={
          ...
          (!selectedArea || selectedItemId !== previouslySelectedItemId)
        }
        contained
      >
        <ItemCard
      ...
      <DiagramSection
        ...
        currentItem={
          selectedItem?.id &&
          selectedArea &&
          selectedItemId === previouslySelectedItemId
            ? selectedItem
            : undefined
        }
      ...
      {isJudge ? (
        <RuleInstruction type="action">
          <Translate
            en={
              <>
                As the judge, place one of your things on the diagram to help
                the other players.
                <br />
                <strong>
                  Simply choose one thing and place in the center of the diagram
                </strong>
                <br />
            ...
            pt={
              <>
                Como juiz, coloque uma de suas coisas no diagrama para ajudar os
                outros jogadores.
                <br />
                <strong>
                  Escolha uma coisa e coloque no centro do diagrama
                </strong>
                <br />
        ...
        <RuleInstruction type="action">
          <Translate
            en={
              <>
                Select one of your things and place them in one of the areas of
                the diagram. If there are already things there, you can try to
                base your placement off of them.
                <br />
                The goal is to correctly place your things in the diagram based
                on the secret rules of each area.
                <br />
                If you place it right, you can place another thing. If you place
                it wrong, you will receive a new thing and it will be the next
                player's turn.
              </>
            }
            pt={
              <>
                Selecione uma de suas coisas e coloque-as em uma das áreas do
                diagrama. Se já houver coisas lá, você pode tentar basear sua
                colocação nelas.
                <br />O objetivo é colocar corretamente suas coisas no diagrama
                com base nas regras secretas de cada área.
                <br />
                Se você colocar certo, poderá colocar outra coisa. Se você
                colocar errado, receberá uma nova coisa e será a vez do próximo
                jogador.
              </>
            }
          />
