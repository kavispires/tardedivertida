  ...
  return (
    <RuleInstruction type="action">
      <Translate
        ...
        <br/>
        A dica tem que ser uma <strong>palavra única</strong> que ajude o adivinhador... adivinhar.
        <br/>
        ...
        <br/>
        You can't use parts of the Secret word, translations, words in the same family (prince/princess), made-up words, or phonetically identical (weather/whether).
        <br/>
...
export function ComparisonRules() {
  return (
    <Surface>
      <Translate
        pt="Hora de comparar as dicas e eliminar as similares!
        <br/>
        O aplicativo elimina automaticamente todas as palavras idênticas, mas os jogadores precisam eliminar as inválidas e similares."
        en="Time to compare the clues and eliminate variants
        <br/>
...
export function ComparisonDetailedRules() {
  return (
    <Surface contained>
      <Translate
        pt="Já eliminamos todas as palavras idênticas, agora, elimine palavras inválidas ou similares.
        <br/>
        Lembre-se que são consideradas dicas iguais palavras derivadas e conjugações: <code>piloto = pilotar = pilotando</code>. Variações como pluralidade, gênero e erros ortográficos também devem ser eliminadas: <code>príncipe = princesa = príncipes = pryncipi</code>."
        en="The app has already eliminated all identical clues, not it's time to eliminate all invalid clues.
        <br/>
...
export function ComparisonPhaseRules({ controller }: { controller: GamePlayer }) {
  return (
    <RuleInstruction type="event">
      <Translate
        pt="Para não virar bagunça, somente {controller} pode clicar nas palavras para eliminá-las ou ativá-las, mas todos podem discutir.
        <br/>
        ...
        en="{controller} is in charge of clicking on the clues to disable or enable them as valid but everybody (but the guesser) should discuss.
        <br/>
