  ...
  return (
    <StepRankingWrapper
      ...
      gainedPointsDescriptions={[
        <Translate
          key="1"
          pt="Acertou a palavra secreta"
          en="Guessed the secret word"
        />,
        <Translate
          key="2"
          pt="Adivinhou na segunda tentativa"
          en="Guessed in the second try"
        />,
        <Translate
          key="3"
          pt="Pontos para o apresentador(a)"
          en="Points for the presenter"
        />,
      ]}
    >
      <SpaceContainer>
