  ...
  return (
    <Step fullWidth>
      ...
      <RuleInstruction type="rule">
        <Translate
          pt="<strong>Clique</strong> em uma das palavras abaixo para selecionar.
          <br/>
          A carta que você não escolher ficará para a próxima rodada."
          en="<strong>Click</strong> on one of the words below to select.
          <br/>
