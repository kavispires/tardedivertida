...
function PlayersBetEntry({
  player,
  brackets,
  contendersByTiers,
}: PlayersBetEntryProps) {
    ...
    >
      ...
      <div
        className={clsx(
          ...
          contendersByTiers.winner[finalCard!.id] &&
            "w-players-bets__square--win",
        )}
      >
        <CharacterCard
          size={50}
          overlayColor={
            contendersByTiers.winner[finalCard!.id] ? "yellow" : "gray"
          }
          character={finalCard!}
          hideName
        />
      ...
      <div
        className={clsx(
          "w-players-bets__square",
          contendersByTiers.final[semiCard!.id] &&
            "w-players-bets__square--win",
        )}
      >
        <CharacterCard
          size={50}
          overlayColor={
            contendersByTiers.final[semiCard!.id] ? "yellow" : "gray"
          }
          character={semiCard!}
          hideName
        />
      ...
      <div
        className={clsx(
          "w-players-bets__square",
          contendersByTiers.semi[quarterCard!.id] &&
            "w-players-bets__square--win",
        )}
      >
        <CharacterCard
          size={50}
          overlayColor={
            contendersByTiers.semi[quarterCard!.id] ? "yellow" : "gray"
          }
      ...
      {selectedCard ? (
        <div
          className={clsx(
            "w-players-bets__square",
            contendersByTiers.winner[selectedCard!.id] &&
              "w-players-bets__square--win",
          )}
        >
          <CharacterCard
            size={50}
            overlayColor={
              contendersByTiers.winner[selectedCard!.id] ? "yellow" : "gray"
            }
