          ...
          <Translate
            pt={
              <>
                ...
                <br />
                Mas qual rua devemos ir? A rua com mais doces? A rua com menos
                medo?
              </>
            }
            en={
              <>
                ...
                <br />
                Which street should we hit first? The one with more candy? The
                one with less horror?
              </>
            }
          />
        </RuleInstruction>
    ...
    <>
      ...
      <RuleInstruction type="action">
        <Translate
          pt={
            <>
              Você estava tranquilo em casa e <strong>6 crianças</strong>{" "}
              apareceram na sua porta. Qual das opções você escolheria para dar
              pra eles? Assustar ou guloseimas?
            </>
          }
          en={
            <>
              You are hanging out at home and <strong>6 kids</strong> showed up
              at our door. Which of the options do you choose to give to them?
              Scare 'em or give treats?
            </>
          }
        />
      </RuleInstruction>
      ...
      <Space className="space-container">
        {track.data.options.map((house: StreetCard) => (
          <Space
            direction="vertical"
            key={house.id}
            className="space-container n-street-house"
          >
