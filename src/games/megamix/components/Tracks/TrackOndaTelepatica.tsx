...
export const TrackOndaTelepatica = ({
  track,
  round,
  onSubmitAnswer,
  user,
  ...
  return (
    <>
      <MinigameTitle
        title={{ pt: "Onda Telepática", en: "Telepathic Waves" }}
      />
      <RuleInstruction type="action">
        <Translate
          pt={
            <>
              Com a carta de as duas ideias opostas e a dica abaixo, você acha
              que o Medidor de Ondas Telepáticas apontaria para a{" "}
              <TextHighlight>Esquerda</TextHighlight>,{" "}
              <TextHighlight>Centro</TextHighlight> ou{" "}
              <TextHighlight>Direita</TextHighlight>?
            </>
          }
          en={
            <>
              With the card of the two opposing ideas and the clue below, do you
              think the Wavelength Measuring device would point to the{" "}
              <TextHighlight>Left</TextHighlight>,{" "}
              <TextHighlight>Center</TextHighlight>, or{" "}
              <TextHighlight>Right</TextHighlight>?
            </>
          }
        />
      </RuleInstruction>
      ...
      <div className="o-simple-dial">
        ...
        >
          ...
          <path
            ...
            className={clsx(
              "o-simple-dial__pointer",
              `o-simple-dial__pointer--p${position}`,
            )}
          ></path>
        </svg>
      </div>
