    ...
    <Step fullWidth>
      ...
      <RuleInstruction type="scoring">
        <Translate
          pt={
            <>
              Cada jogador ganha <PointsHighlight>pontos</PointsHighlight> por cada cliente da sua própria cor
              que conseguiu atendimento e dependendo de quantos pontos a posição dá.
              <br />
          ...
          en={
            <>
              Each player scores <PointsHighlight>points</PointsHighlight> for each customer of their own
              color that got served, depending on how many points the position gives.
              <br />
