  ...
  return (
    <Step fullWidth>
      ...
      <RuleInstruction type="action">
        <Translate
          pt="Com o objeto selecionado, <strong>escreva</strong> uma dica que melhor conecta seu objeto com a característica sorteada para você (destacada abaixo).
          <br/>
          O jogo consiste em eliminar as características restantes até que apenas a sua permaneça."
          en="With the selected object, <strong>write</strong> a clue that best connects your object with the assigned characteristic for you (highlighted in pink below).
          <br/>
      ...
      <RuleInstruction type="rule">
        <Translate
          pt="A dica que você escrever deve ser um objeto manufaturado que você possa tocar.
          <br/>
          ...
          en="The clue object you write must be a man-made object you can touch.
          <br/>
