        ...
        >
          <Surface>
            <Translate
              ...
              <br/>
              Você ganha {points3} se acertar o planejamento!
              <br/>
              O engenheiro chefe ganha {points1} para cada jogador que acertar!
              <br/>
              Quem errar, ganha {points1} para cada jogador que pensou igual!"
              en="Let's see if you, builder, thought like the lead engineer.
              <br/>
              You earn {points3} if you match the plan!
              <br/>
              The lead engineer earns {points1} for each player who matches!
              <br/>
              Those who miss earn {points1} for each player who thought the same!"
              values={{
