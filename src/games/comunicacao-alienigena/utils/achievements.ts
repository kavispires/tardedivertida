...
export const achievementsReference: AchievementReference = {
  PLAYED_AS_ALIEN: {
    ...
    description: {
      ...
      pt: 'Jogou como o Alienígena',
    },
  },
  MOST_BLANK_OBJECTS: {
    id: 'MOST_BLANK_OBJECTS',
  ...
  MOST_CORRECT_OBJECTS: {
    id: 'MOST_CORRECT_OBJECTS',
  ...
  PLAYED_AGAINST_BOT_ALIEN: {
    id: 'PLAYED_AGAINST_BOT_ALIEN',
    doc: 'All players who played against the bot alien',
    icon: 'person',
    title: {
      en: 'Bot Alien Opponent',
      pt: 'Oponente Alienígena Bot',
    },
    description: {
      en: 'Played against the bot alien',
      pt: 'Jogou contra o alienígena bot',
    },
  },
  FEWEST_QUESTIONED_OBJECTS: {
    id: 'FEWEST_QUESTIONED_OBJECTS',
  ...
  MOST_QUESTIONED_OBJECTS: {
    id: 'MOST_QUESTIONED_OBJECTS',
    doc: 'How many objects were inquired by the player',
    icon: 'loupe',
    title: {
      en: 'Most Curious',
  ...
  SINGLE_OBJECT_INQUIRY: {
    id: 'SINGLE_OBJECT_INQUIRY',
