    ...
    <Step fullWidth announcement={announcement}>
      ...
      <RuleInstruction type="rule">
        <Translate
          pt={
            <>
              O(A) skier <AvatarName player={skier} /> está descendo essa montanha e finalizará em uma das
              cabanas. Qual cabana você acha que ele(a) vai escolher?
              <br />
          ...
          en={
            <>
              The skier <AvatarName player={skier} /> is skiing down this mountain and will finish in one of
              the lodges. Which lodge do you think they will choose?
              <br />
