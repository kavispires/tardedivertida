...
export function PhaseStartingResults({ players, state }: PhaseProps<PhaseStartingResultsPhase>) {
  ...
  return (
    <PhaseContainer phase={state?.phase} allowedPhase={PHASES.ESQUIADORES.STARTING_RESULTS}>
      <SnowEffect />
