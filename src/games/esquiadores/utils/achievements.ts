...
export const achievementsReference: AchievementReference = {
  ...
  FEWEST_GROUP_BOOST_BETS: {
    id: 'FEWEST_GROUP_BOOST_BETS',
  ...
  MOST_GROUP_BOOST_BETS: {
    id: 'MOST_GROUP_BOOST_BETS',
    doc: 'Boost bets with other players',
    icon: 'two',
    title: {
  ...
  FEWEST_GROUP_FINAL_BETS: {
    id: 'FEWEST_GROUP_FINAL_BETS',
  ...
  MOST_GROUP_FINAL_BETS: {
    id: 'MOST_GROUP_FINAL_BETS',
    doc: 'Final bets with other players',
    icon: 'three',
    title: {
  ...
  HIGHEST_BET: {
    ...
    description: {
      en: 'Placed the highest single bet value during the game.',
      pt: 'Jogador que fez a aposta de maior valor durante o jogo.',
    },
  },
  FEWEST_GROUP_INITIAL_BETS: {
    id: 'FEWEST_GROUP_INITIAL_BETS',
  ...
  MOST_GROUP_INITIAL_BETS: {
    id: 'MOST_GROUP_INITIAL_BETS',
    doc: 'Initial bets with other players',
    icon: 'one',
    title: {
