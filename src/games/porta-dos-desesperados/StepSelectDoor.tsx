...
export function StepSelectDoor({
  ...
  return (
    <Step fullWidth>
      ...
      >
        <Translate
          pt="O livro contém dicas dadas por {possessed} que ainda está possuído pelo livro e não pode falar.
          <br/>
          Vocês tem {timeLimit} minutos para decidir qual(quais) porta(s) entrar.
          <br/>
          ...
          en="The book contains hints given by {possessed} who is still possessed by the book and can't speak.
          <br/>
      ...
      <RuleInstruction type="action">
        <Translate
          pt={`<strong>Selecione</strong> uma das portas que você acha que mais se relaciona com o livro.
          <br/>
          ${trap === TRAPS.LOCKED_CHOICE ? 'Você não pode trocar de porta depois de escolher!' : 'Você pode trocar de porta quantas vezes quiser até confirmar sua escolha ou o tempo acabar.'}`}
          en={`<strong>Select</strong> one of the doors you think is most related to the book.
          <br/>
          ${trap === TRAPS.LOCKED_CHOICE ? 'You cannot change your door after you choose!' : 'You can change your door as many times as you want until you confirm your choice or time runs out.'}`}
        />
      </RuleInstruction>
