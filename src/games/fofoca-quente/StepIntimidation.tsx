        ...
        <Surface contained>
          <Flex justify="center">
            ...
            <div>
              ...
              >
                <Translate
                  en="Now you should spread the nastiest rumor possible to drive that student to leave the school!
                  <br/>
                  ...
                  pt="Hora de deixar um bilhete maldoso no armário de 2 estudantes! Eles ficarão com medo e não poderão responder a nenhuma pergunta do detetive nesta rodada.
                  <br/>
                  <strong>Clique</strong> nos estudantes que você quer intimidar e o botão estará disponível se possível.
                  <br/>
                  Você não pode intimidar nenhum estudante que esteja na mesma localização que o detetive ou que já esteja intimidado, mas você pode até mesmo se intimidar (é só fingir se ele te perguntar algo)."
                />
