        ...
        <Surface contained>
          <Flex justify="center">
            ...
            <div>
              ...
              >
                <Translate
                  en="Now you should spread the nastiest rumor possible to drive that student to leave the school!<br/><strong>Click</strong> on the student you want to spread the rumor about and that follows your motivation, select a rumor then submit!<br/>Remember, you win if you can spread 5 rumors before getting caught.<br/>TODO: Can skip option once per game"
                  pt="Hora de deixar um bilhete maldoso no armário de 2 estudantes! Eles ficarão com medo e não poderão responder a nenhuma pergunta do detetive nesta rodada.<br/><strong>Clique</strong> nos estudantes que você quer intimidar e o botão estará disponível se possível.<br/>Você não pode intimidar nenhum estudante que esteja na mesma localização que o detetive ou que já esteja intimidado, mas você pode até mesmo se intimidar (é só fingir se ele te perguntar algo)."
                />
        ...
        <Surface contained>
          <Flex justify="center">
            ...
            <div>
              ...
              >
                <Translate
                  en="The gossiper is intimidating 2 students this round (leaving a nasty note in their locker), they will be scared and won't be able to answer any questions for you this round.<br/>The gossiper cannot intimidate any student in the same location as you or that is already intimidated but he can intimidate even himself (just pretend if you ask him any question)<br/>Intimidated students will be turned grayscale on the board."
