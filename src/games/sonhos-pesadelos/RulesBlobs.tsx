  ...
  <Translate
    pt={
      <>
        ...
        <br />
        Preste atenção em seu pesadelo (carta com borda preta), se alguém achar que sua dica é relacionada a
    ...
    en={
      <>
        ...
        <br />
        Pay attention to your nightmare (black bordered card) because if any player thinks that your clue is
