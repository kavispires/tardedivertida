...
export function PhaseCardPlay({ state, players, user }: PhaseProps<PhaseCardPlayState>) {
  ...
  const announcement = (
    ...
    >
      <Surface>
        <Translate
          en="Now players will see the story for the round and select one of their cards that best match the story.
          <br/>
          If any other player vote for your card later, you will get {points}."
          pt="Agora, jogadores verão a história da rodada e selecionarão uma de suas cartas que mais se aproxime da história.
          <br/>
          Na próxima fase, se algum outro jogador selecionar sua carta, você ganha {points}!"
          values={{
