...
- **Planejamento Urbano** — City map updated for new GridMap toolkit; gallery shows adjacent wrong construction locations  
...
- **Daily Hub** — Added sortBy (name or release date) to Hub; improved filters and game listing; added timer display for each game; carousel to NextGameSuggestion
...
- **Lobby** — Added message for duplicated avatars; button to reload meta when game is restarted; fixed reload game flow  
