...
export const CONTROLE_DE_ESTOQUE_ACHIEVEMENTS = {
  ...
  MOST_OUT_OF_ORDER_ATTEMPTS: 'MOST_OUT_OF_ORDER_ATTEMPTS',
  MOST_FIRST_ROUND_ATTEMPTS: 'MOST_FIRST_ROUND_ATTEMPTS',
  MOST_SECOND_ROUND_ATTEMPTS: 'MOST_SECOND_ROUND_ATTEMPTS',
  MOST_THIRD_ROUND_ATTEMPTS: 'MOST_THIRD_ROUND_ATTEMPTS',
  MOST_FULFILLED_AT_ONCE: 'MOST_FULFILLED_AT_ONCE',
  MOST_WRONG_ORDERS: 'MOST_WRONG_ORDERS',
  MOST_SKIPPED_ORDERS: 'MOST_SKIPPED_ORDERS',
} as const;
