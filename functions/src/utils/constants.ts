...
const GAMES = [
  ...
  {
    name: 'na-fila-do-banco',
    code: 'F',
    key: 'NA_FILA_DO_BANCO',
  },
  {
    name: 'na-rua-do-medo',
    code: 'N',
...
export const TDR_RESOURCES = {
  ...
  CRIME_REASONS: 'crime-reasons', // dual-language
...
/**
 * Colors by avatar ID, with their hue for distance calculations.
 **/
