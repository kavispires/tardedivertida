...
export const feedEmulatorDaily = async () => {
  ...
  const dailyMock = {
    ...
    'ta-na-cara': JSON.parse(
      `{"id":"2025-00-00","number":0,"type":"ta-na-cara","testimonies":[{"testimonyId":"t-1-pt","question":"Ele(a) já foi para um jogo em um estádio?","nsfw":false,"suspectsIds":["us-gb-12","us-gb-130","us-gb-115","us-gb-124"]},{"testimonyId":"t-2-pt","question":"Ele(a) gosta de música clássica?","nsfw":false},{"testimonyId":"t-3-pt","question":"Ele(a) acredita em alienígenas?","nsfw":true}], "suspectsIds":["us-gb-02","us-gb-03","us-gb-04","us-gb-05","us-gb-06","us-gb-07","us-gb-08"]}
      `,
    ),
