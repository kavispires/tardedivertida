...
export const feedEmulatorDaily = async () => {
  ...
  const dailyMock = {
    ...
    'ta-na-cara': JSON.parse(
      `{"id":"2025-00-00","number":0,"type":"ta-na-cara","testimonies":[{"testimonyId":"t-1-pt","question":"Ele(a) já foi para um jogo em um estádio?","nsfw":false},{"testimonyId":"t-2-pt","question":"Ele(a) gosta de música clássica?","nsfw":false},{"testimonyId":"t-3-pt","question":"Ele(a) acredita em alienígenas?","nsfw":true}], "suspectsIds":["us-ct-02","us-ct-03","us-ct-04","us-ct-05","us-ct-06","us-ct-07","us-ct-08"]}
      `,
    ),
