...
export const feedEmulatorDaily = async () => {
  ...
  const dailyMock = {
    ...
    'controle-de-estoque': {
      ...
      language: 'pt',
      orders: ['good-1', 'good-2', 'good-3', 'good-4', 'good-17'],
      id: '2023-10-31',
