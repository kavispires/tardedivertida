...
import * as bombaRelogioEngine from '../engine/bomba-relogio';
import * as colegasDeQuartoEngine from '../engine/colegas-de-quarto';
...
import * as naFilaDoBancoEngine from '../engine/na-fila-do-banco';
