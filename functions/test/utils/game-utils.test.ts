...
describe('game-utils', () => {
  ...
  describe('dealList', () => {
    ...
    test('it deal items from a list to each player equally', () => {
      const result = gameUtils.dealList(sample, players, 1);
    ...
    test('it deal items from a list to each player equally to given propertyName', () => {
      const result = gameUtils.dealList(sample, players, 3, 'result');
    ...
    test('it deal items from a list equally repeating insufficient items if recursive is true', () => {
      sample = ['A', 'B', 'C'];
      const result = gameUtils.dealList(sample, players, 2, 'result', true);
